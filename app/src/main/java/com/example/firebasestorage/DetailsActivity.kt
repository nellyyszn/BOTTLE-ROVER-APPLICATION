...
class DetailsActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            var storeList = mutableStateListOf<Stores?>()
            ...
            db.collection("Stores").get()
                .addOnSuccessListener { queryDocumentSnapshots ->
                    if (!queryDocumentSnapshots.isEmpty) {
                        ...
                        for (d in list) {
                            val c: Stores? = d.toObject(Stores::class.java)
                            storeList.add(c)
            ...
            firebaseUI(LocalContext.current, storeList)
        }
    }
}
...
fun firebaseUI(context: Context, courseList: SnapshotStateList<Stores?>) {
    ...
    Column(modifier = Modifier
        ...
        TopAppBar(
            ...
            colors = TopAppBarDefaults.largeTopAppBarColors(Color.Yellow),
            navigationIcon = {
                IconButton(onClick = {
        ...
        LazyColumn {
            itemsIndexed(courseList) { index, item ->
                Card(onClick = {
                    Toast.makeText(context, courseList[index]?.StoreName + " selected..", Toast.LENGTH_SHORT).show()
                },
                    ...
                    Column(modifier = Modifier.padding(8.dp).fillMaxWidth()
                        ...
                        courseList[index]?.StoreName?.let {
                            Text(
                                text = it,
